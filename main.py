...
UI_TEXT = {
    'EN': {
        ...
        # Prompts below might not be directly applicable to st_audiorec, it has its own UI
    ...
    'FR': {
        ...
        # Prompts below might not be directly applicable to st_audiorec
...
def rag_pipeline(query, k=2, lang='EN'):
    ...
    no_info_msg = UI_TEXT[lang].get('response_no_info', ("Je suis désolé..." if lang == 'FR' else "I'm sorry..."))
...
with tabs[1]:
    ...
    if wav_audio_data is not None:
        st.info(UI_TEXT[CURRENT_LANG]["processing"])
        transcription = None
        try:
